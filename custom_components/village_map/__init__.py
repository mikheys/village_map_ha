...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    # 2. Служба подтверждения удаления
    ...
    # 3. Служба восстановления объекта
    ...
    # 6. Синхронизация атрибута (из HA на карту)
    async def handle_sync_attribute(call: ServiceCall):
        ...
        val = state.state
        # Разрешаем отправку unknown/unavailable для истории отключений
